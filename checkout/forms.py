...
class MakePaymentForm(forms.Form):
    ...
    credit_card_number = forms.CharField(
        label="Credit card number", min_length=12, required=False)
...
class OrderForm(forms.ModelForm):
    ...
    country = forms.CharField(
        error_messages={'required': 'Please insert country'})
    town_or_city = forms.CharField(
        error_messages={'required': 'Please insert town or a city'})
    street_address1 = forms.CharField(
        error_messages={'required': 'Please insert street address'})
